...
extension WQComposeTextView {
    ...
    var emoticonText: String {
        ...
        attrStr.enumerateAttributes(in: NSRange(location: 0, length: attrStr.length), options: [], using: { (dict, range, _) in
            ...
            if let attachment = dict["NSAttachment"] as? WQEmoticonAttachment {
                // print("图片 \(attachment)")
    ...
    func insertEmoticon(em: WQEmotion?) {
...
fileprivate extension WQComposeTextView {
